<template>
    <div v-show="showHelp" class="w-80 lg:w-[30%] h-96 flex flex-col items-center justify-start bg-dark border-2 border-light shadow-xl shadow-dark p-2 fixed top-1/2 left-1/2 z-50 -translate-x-1/2 -translate-y-1/2 rounded-xl">
